            ...
            <div class="col-md-6 offset-md-3">
                <div class="logreg-box">
                    <div class="form-box login">
                        <form method="POST" action="registerNextProcess.php" enctype="multipart/form-data">
                            <h2>PROFILE DETAILS</h2>
                            <div class="input-box">
                                <!-- <span class="icon"><box-icon name='user' type='solid' color='#d9b8c4' ></box-icon></span> -->
                                <input type="name" placeholder="Name" name="name" id="name" style="color: #f4f7be;" required> 
                            </div>
                            <div class="input-box">
                                <!-- <span class="icon"><box-icon name='envelope' type='solid' color='#d9b8c4' ></box-icon></span> -->
                                <input type="text" placeholder="Phone Number" name="phonenumber" id="phonenumber" style="color: #f4f7be;" required> 
                            </div>
                            <div class="input-box">
                                <!-- <span class="icon"><box-icon name='lock' type='solid' color='#d9b8c4' ></box-icon></span> -->
                                <input type="text" placeholder="Bio" name="bio" id="bio" style="color: #f4f7be;" required> 
                            </div>
                            <!-- <div class="input-box"> -->
                                <!-- <span class="icon"><box-icon name='lock' type='solid' color='#d9b8c4' ></box-icon></span> -->
                            <div style="display: flex;">
                                <p style="flex:1; color:#D9B8C4; font-weight:400">Profile Picture:</p>
                                <input type="file" name="profile_image_input" id="profile_image_input" accept="image/*" style="flex: 2.2; color:#D9B8C4">
                                
                            </div>
                                <!-- <input type="password" placeholder="Confirm Password" name="confirmpassword" id="confirmpassword" style="color: #f4f7be;" required>  -->
                            <!-- </div> -->
                            <div class="remember-forget" style="position:absolute; top: 68%; left:-5%">
